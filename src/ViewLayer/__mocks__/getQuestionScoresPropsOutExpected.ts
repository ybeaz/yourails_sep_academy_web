...
const successTrue_AuthTrue_NamesTrue_isEditNameVisibleFalse: GetQuestionScoresPropsOutResType[] = [
  ...
  },
  {
    navLinkProps: {
      ...
      to: {
        ...
        searchStr:
          '?client_id=635evv2b44uuluiu6au25djr64&response_type=code&redirect_uri=http://localhost:3440&scope=email+openid+profile',
      },
      isExternal: true,
      isDisabled: false,
      isDisplaying: true,
  ...
  },
  {
    navLinkProps: {
      ...
      to: {
        pathname: '/m/l9U7XMpux7eD/Test-module',
        search: {
          pageModules: '1',
          pageTags: '1',
          pageDocuments: '1',
